  ...
  return (
    <div className="min-h-screen bg-canvas">
      ...
      <div className="pl-rail">
         ...
         *
         * 1600px 은 표 기준이다. 어드민에서 가장 넓은 것이 표고, 열이 여덟 개쯤 되면
         * 1400 에서 가로 스크롤이 생긴다. 반대로 제한을 아예 풀면 넓은 모니터에서
         * 한 줄이 화면 끝까지 늘어나 눈이 다음 줄 첫 글자를 못 찾는다.
         *
         * 상하 여백을 좌우보다 조금 크게 둔다. 상단 바 바로 아래에 제목이 붙으면
         * 두 줄이 한 덩어리로 읽혀 위계가 무너진다. */}
        <main className="mx-auto w-full max-w-[1600px] px-6 pb-10 pt-6">
          <Outlet />
        </main>
      </div>
    </div>
