...
import static coffeeshout.minigame.cardgame.domain.card.MultiplierCard.DOUBLE;
import static coffeeshout.minigame.cardgame.domain.card.MultiplierCard.INVERT;
import static coffeeshout.minigame.cardgame.domain.card.MultiplierCard.QUADRUPLE;
