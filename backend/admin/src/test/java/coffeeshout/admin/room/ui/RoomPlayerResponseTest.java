...
class RoomPlayerResponseTest {
    ...
    void 로그인_사용자는_게스트가_아니고_계정_정보를_함께_싣는다() {
        final RoomPlayer player =
                new RoomPlayer(1L, "엠제이", PlayerType.HOST, 100L, "mj", "AB12C", JOINED_AT);
    ...
    void userId가_없으면_게스트로_표시한다() {
        ...
        final RoomPlayer guest =
                new RoomPlayer(2L, "손님", PlayerType.GUEST, null, null, null, JOINED_AT);
    ...
    void 방에서_쓴_이름과_계정_닉네임을_모두_싣는다() {
        ...
        final RoomPlayer player =
                new RoomPlayer(1L, "방에서쓴이름", PlayerType.GUEST, 100L, "계정닉네임", "AB12C", JOINED_AT);
